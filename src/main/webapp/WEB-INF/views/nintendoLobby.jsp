...
<body>
    ...
    <div id = "main-body">
    	...
    	<h1 style="margin-top: 1em;">Nintendo Discussion</h1>
    	...
    	<div id="comment-container" style = "width:70%;">
	         <div id = "review-table" class = "reviews bg-light">
	             <table id="myTable" class = "table">
	                  ...
	                  <c:forEach items="${nintendoComments}" var="comment">
	                 		<tr>
	                 			<td>
	   ...
	   <h2>What are your thoughts on your favorite games?</h2>
		<div id="submit-form">		
    		<form:form action = "registerNewNintendoComment" method = "POST" modelAttribute = "newComment">
